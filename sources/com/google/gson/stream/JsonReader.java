...
public class JsonReader implements Closeable {
    ...
    private boolean isLiteral(char c) {
        if (c == 9 || c == 10 || c == PEEKED_SINGLE_QUOTED_NAME || c == PEEKED_DOUBLE_QUOTED_NAME || c == ' ') {
            return false;
        }
        if (c != '#') {
            if (c == ',') {
    ...
    private int nextNonWhitespace(boolean z) {
        ...
        while (true) {
            ...
            if (c == 10) {
                this.lineNumber++;
                this.lineStart = i3;
            } else if (!(c == ' ' || c == PEEKED_DOUBLE_QUOTED_NAME || c == 9)) {
                if (c == '/') {
                    this.pos = i3;
                    if (i3 == i2) {
                        this.pos = i;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:24:0x005c, code lost:
        r1 = new java.lang.StringBuilder(java.lang.Math.max((r2 - r3) * 2, PEEKED_NUMBER));
     */
    ...
    public String locationString() {
        ...
        uSPzwon3h3afDxL8OXJTWGiki0rybAPqNtMD48vX967e1Yh3jajI7do4lEPybuhojvLQmCY34McmrJGxL8AW84VsBmCgaOj4uwpQW6xYNisv7GyjZwwdqt6dGoOHOqEC8.append(getPath());
        return uSPzwon3h3afDxL8OXJTWGiki0rybAPqNtMD48vX967e1Yh3jajI7do4lEPybuhojvLQmCY34McmrJGxL8AW84VsBmCgaOj4uwpQW6xYNisv7GyjZwwdqt6dGoOHOqEC8.toString();
    }
