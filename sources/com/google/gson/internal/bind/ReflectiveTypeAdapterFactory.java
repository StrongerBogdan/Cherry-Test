...
public final class ReflectiveTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public static final class RecordAdapter<T> extends Adapter<T, Object[]> {
        ...
        public void readField(Object[] objArr, JsonReader jsonReader, BoundField boundField) {
            ...
            throw new IllegalStateException(gevZisGpxsTSC2qbbnIQnk9DyjfZCnV2T4t4wpPB9Vs9pdSjZYxPGSiG.Peh2iernJBsMiysuDaEEhSyoW0hY6wz4p5JrcYuartaKXGwf325V19iGs4irf5afpcICDX8gqxpUgk7Tw(sb, boundField.fieldName, "', unable to determine which argument in the constructor the field corresponds to. This is unexpected behavior, as we expect the RecordComponents to have the same names as the fields in the Java class, and that the order of the RecordComponents is the same as the order of the canonical constructor parameters."));
        }
    }
            ...
            public void readIntoField(JsonReader jsonReader, Object obj) {
                ...
                if (read != null || !isPrimitive) {
                    if (z6) {
                        ...
                        throw new JsonIOException(wXB0QvqHSWUl8vRXKkBslrNk5URNK8U0eO1KlvjtK4Di22c3qVSzWTiPoK8KpPAIJvk9i3Qm8JFJlcAW8QTbLEiuJz8Cr.H0pSch9XQw75sQDNHGRLAUbXt3bOxqOZ("Cannot set value of 'static final' ", ReflectionHelper.getAccessibleObjectDescription(this.field, false)));
                    }
                ...
                if (this.serialized) {
                    ...
                    if (method2 != null) {
                        try {
                            ...
                            throw new JsonIOException(wXB0QvqHSWUl8vRXKkBslrNk5URNK8U0eO1KlvjtK4Di22c3qVSzWTiPoK8KpPAIJvk9i3Qm8JFJlcAW8QTbLEiuJz8Cr.uOyBevV98ltUOUilp7DoFm42UWPOTxVsABEgMe8CCuScERPxr2BKOn("Accessor ", ReflectionHelper.getAccessibleObjectDescription(method2, false), " threw exception"), e.getCause());
                        }
                    } else {
                ...
                if (includeField || includeField2) {
                    ...
                    if (!z2) {
                        ...
                        if (accessor.getAnnotation(cls4) == null || field.getAnnotation(cls4) != null) {
                            ...
                            throw new JsonIOException(wXB0QvqHSWUl8vRXKkBslrNk5URNK8U0eO1KlvjtK4Di22c3qVSzWTiPoK8KpPAIJvk9i3Qm8JFJlcAW8QTbLEiuJz8Cr.uOyBevV98ltUOUilp7DoFm42UWPOTxVsABEgMe8CCuScERPxr2BKOn("@SerializedName on ", ReflectionHelper.getAccessibleObjectDescription(accessor, z7), " is not supported"));
                        }
                    }
                    if (!z8 && method == null) {
